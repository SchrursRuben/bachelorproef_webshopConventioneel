...
import SpotifyLogo from '../images/spotify/Spotify_Icon_RGB_Green.png'
    ...
    useEffect(() => {
        try {
            ...
            if (currentAlbum && albumId) {
                const priceCurrentAlbum = pricesFromStorage.find(item => item.id === albumId) || {}
        ...
        <>
            <div className='releaseDetailsWrapper'>
                <div className='releaseDetails'>
                    <div className='releaseTitleAndArtistsAndSpotifyButton'>
                        <div className='releaseTitleAndSpotifyButton'>
                            <h2>{currentAlbum?.name}</h2>
                            <div className='spotifyButton' onClick={handleSpotifyButton}>
                                <p>Listen Here</p>
                    ...
                    <div className='releaseCoverArtInfoBuyButtonAndTracks'>
                        <div className='releaseCoverArt'>
                            <img src={currentAlbum?.images?.at(0).url} alt="releaseCoverImage" />
                        </div>
                        <div className='releaseInfoBuyButtonAndTracks'>
                            ...
                            <div className='releaseBuyButtonAndTracks'>
                                ...
                                <div className='releaseTracks'>
                                    <h2>Tracks</h2>
                                    {
                                        currentAlbum?.tracks?.items?.map(track => {
                                            return <p key={track?.track_number}>{track?.track_number} - {track?.name}</p>
                                        })
                                    }
                                </div>
                            </div>
